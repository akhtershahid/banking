...
import com.mybank.banking.MyBankConfiguration;
...
public class TestResources {
    ...
    @Rule
    public final DropwizardAppRule<MyBankConfiguration> RULE =
    ...
    @Test
    public void testTransfer_senderAndReceiverAccountSame_expect400() {
        //GIVEN: sender and receiver account is same
        Response response = client.target(
                String.format("http://localhost:%d/account", RULE.getLocalPort()))
                .request()
                .post(null);
        ...
        response = client.target(
                String.format("http://localhost:%d/transfer", RULE.getLocalPort()))
                .request()
                .post(Entity.entity(new Transfer(1L, 1L, 100L), MediaType.APPLICATION_JSON_TYPE));
